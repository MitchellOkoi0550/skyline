    ...
    <div class="container-fluid bg-dark">
        <div class="row">
            <div class="col-12 text-center">
                <h1 class="display-4 text-white">Add Testimonial</h1>
            </div>
        </div>
    </div>
    <!-- Page Header End -->
    ...
    <div class="ol-lg-8">
        <div class="row g-0">
            <div class="col-lg-6 py-4 px-1 mx-auto" style="max-width: 700px;">
                <form action="include/testimonialinc.php" method="POST">
                    <div class="row g-3">
                        <div class="col-6">
                            <div class="form-floating">
                                <input type="text" name="clientname" class="form-control" id="form-floating-1" required placeholder="Title">
                                <label for="form-floating-1">Client Name</label>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-floating">
                                <input type="text" name="clientposition" class="form-control" id="form-floating-1" required placeholder="Title">
                                <label for="form-floating-1">Client Position</label>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="form-floating">
                                <textarea class="form-control" id="comment" name="clientcomment" placeholder="Comment" id="form-floating-4" style="height: 400px"></textarea>
                                <label for="form-floating-4">Comments</label>
                              </div>
                        </div>
                        <div class="col-12">
                            <div class="form-floating">
                            <input type="file" id="fileInput" name="clientimage" accept="image/jpeg, image/jpg, image/png">
                            </div>
                        </div>                        
                        <div class="col-12">
