...
require_once "include/viewclientrequest_inc.php";
            ...
            <div class="navbar-nav ms-auto py-0 me-n3">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu m-0">
                        ...
                        <a href="viewclientrequest.php" class="dropdown-item active">Client Request</a>
                    </div>
                </div>
    ...
    <div class="row">
        <div class="col-lg-9 py-2 px-1 mx-auto">
            <div>
                ...
                ?>
                <form action="include/viewclientrequest_inc.php" method="post" class="row g-5">
                    <table>
                        <tr>
                            <th class="container-fluid bg-dark text-white">Name</th>
                            <th class="container-fluid bg-dark text-white">Email</th>
                            <th class="container-fluid bg-dark text-white">Service</th>
                            <th class="container-fluid bg-dark text-white">Request Date</th>
                            <th class="container-fluid bg-dark text-white">Action</th>
                        </tr>
                        <?php 
                            // Loop through the subset of records for the current page
                            foreach ($subset_posts as $m) {
                            ?>
                            <tr>
